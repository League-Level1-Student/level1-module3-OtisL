...
public class Jukebox implements Runnable, ActionListener {
	JButton ali = new JButton();
	JButton butter = new JButton();
	Song song = new Song("Ali-A Intro (Normal).mp3");
	Song butter2 = new Song("Butter 2 (Official Music Video).mp3");
	...
	public void run() {
		...
		panel.add(ali);
		panel.add(butter);
		JLabel buttah = loadImage("butter 2.jpg");
		JLabel brass = loadImage("ali-a.jpeg");
		ali.add(brass);
		butter.add(buttah);
